    ...
    <div className="threat-run-controls">
      ...
      {!llmOk ? (
        <p className="status status-error">
          LLM offline: {status?.llm?.reason || 'Start Ollama and set MASTYF_AI_LLM_ENABLED=true'}
        </p>
      ) : null}
      <div className="threat-run-row">
        ...
        <div className="threat-run-block">
          <p className="hint">
            Auto research writes adv fixtures directly (requires MASTYF_AI_THREAT_RESEARCH_AUTO +
